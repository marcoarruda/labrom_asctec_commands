...
int main(int argc, char **argv)
{
  ...
  // Start subscribers
  ros::Subscriber sub_thrust = node.subscribe("/thrust_cmd", 1, thrustCallback);
  ros::Subscriber sub_attitude = node.subscribe("/attitude_cmd", 1, attitudeCallback);
  ...
  while(ros::ok()) {
    ...
    */
    ...
    mav_ctrl.z - 0 ... 1
    */
    msg_mav_ctrl.z = ((float) thrust.data) / 1000;
    // yaw
